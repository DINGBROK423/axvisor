...
echo "正在运行测试..."
cargo xtask qemu --build-config tmp/configs/qemu-aarch64.toml --qemu-config tmp/configs/qemu-aarch64-info.toml --vmconfigs tmp/configs/arceos-blktest-aarch64-qemu-smp1.toml
